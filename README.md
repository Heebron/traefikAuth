...
Usage:
  ...
  -policy string
        policyMap file (default "/home/user/.traeficForwardAuthPolicy.yaml")
  -version
...
In order to use TLS, you must provide both the server cert *-certFile* and matcher key *-keyFile* on the command
line.
